...
def test_hold_override_logic():
    ...
    analysis_input = AssetAnalysisInput(
        symbol="AAPL",
        market_data={"action": "hold", "confidence": 0.2, "reasoning": "No strong signal."},
        technical_indicators={
            "rsi": 45, "macd": 0.1, "sma_20": 150, "price_vs_sma20": 0.5
        },
        news_sentiment=None,
        reflection_insights=None,
        historical_ai_context=None
    ...
    decision = bot.make_trading_decision(analysis_input, min_confidence=0.5)
    assert decision.final_action in ("buy", "sell"), f"Override failed, got: {decision.final_action}"
    ...
    analysis_input = AssetAnalysisInput(
        symbol="TSLA",
        market_data={"action": "hold", "confidence": 0.2, "reasoning": "Mixed signals."},
        technical_indicators={
            "rsi": 80, "macd": -1.0, "sma_20": 900, "price_vs_sma20": 2.0
        },
        news_sentiment=None,
        reflection_insights=None,
        historical_ai_context=None
    ...
    decision = bot.make_trading_decision(analysis_input, min_confidence=0.5)
    assert decision.final_action == "hold", f"Should not override, got: {decision.final_action}"
    ...
    analysis_input = AssetAnalysisInput(
        symbol="GOOGL",
        market_data={"action": "hold", "confidence": 0.2, "reasoning": "Insufficient data."},
        technical_indicators={
            "rsi": 50, "macd": 0.2  # missing sma_20, price_vs_sma20
        },
        news_sentiment=None,
        reflection_insights=None,
        historical_ai_context=None
