...
class TradingBotTester:
    ...
    def test_technical_indicators(self):
        ...
        try:
            ...
            print(
                f"   [OK] Technical Indicators: RSI={indicators['rsi']:.2f}, MACD={indicators['macd']:.2f}"
            )
            return True
        except Exception as e:
    ...
    def test_risk_management(self):
        ...
        try:
            ...
            print(
                f"   [OK] Risk Management: Level={risk_metrics['risk_level']}, P&L=${risk_metrics['profit_loss']:.2f}"
            )
            return True
        except Exception as e:
    ...
    def test_portfolio_management(self):
        ...
        try:
            ...
            print(
                f"   [OK] Portfolio Management: Total Value=${metrics.get('total_value', 0):.2f}"
            )
            return True
        except Exception as e:
    ...
    def test_trade_execution(self):
        ...
        try:
            ...
            success, order = executor.execute_trade(
                symbol="AAPL", side="buy", quantity=1, confidence=0.8
            )
            if success:
